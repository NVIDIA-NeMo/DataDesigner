...
class ModalityContext(ABC, BaseModel):
    ...
    data_type: ModalityDataType = Field(description="Format of the modality data ('url' or 'base64')")
...
class ModelProvider(ConfigBase):
    ...
    extra_body: dict[str, Any] | None = Field(default=None, description="Additional parameters to pass in API requests")
    extra_headers: dict[str, str] | None = Field(default=None, description="Additional headers to pass in API requests")
