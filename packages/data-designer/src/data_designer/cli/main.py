...
from data_designer.cli.commands.web import review_command
...
# Add review UI command
app.command(name="review", help="Launch the dataset review UI", rich_help_panel="Review")(
    review_command
)
