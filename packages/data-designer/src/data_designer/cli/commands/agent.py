...
from data_designer.cli.services.agent_context_service import (
    AgentContextError,
    AgentContextService,
)
...
def context_command() -> None:
    ...
    _run(lambda: _SERVICE.get_context(DATA_DESIGNER_HOME), format_context_text)
...
def types_command(
    ...
    _run(lambda: _SERVICE.get_types(family), format_types_text)
