...
def test_create_command_delegates_to_controller(mock_ctrl_cls: MagicMock) -> None:
    ...
    create_command(
        workflow_args=["config.yaml"], num_records=10, dataset_name="dataset", artifact_path=None, output_format=None
    )
...
def test_create_command_default_artifact_path_is_none(mock_ctrl_cls: MagicMock) -> None:
    ...
    create_command(
        workflow_args=["config.yaml"], num_records=5, dataset_name="ds", artifact_path=None, output_format=None
    )
