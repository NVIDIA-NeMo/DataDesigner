...
class DataDesigner(DataDesignerInterface[DatasetCreationResults]):
    ...
    Args:
        ...
        seed_dataset_readers: Optional list of seed dataset readers. If None, uses
            default readers.
    ...
    def __init__(
        ...
        *,
        ...
        seed_dataset_readers: list[SeedDatasetReader] | None = None,
        ...
        self._seed_dataset_reader_registry = SeedDatasetReaderRegistry(
            readers=seed_dataset_readers or DEFAULT_SEED_DATASET_READERS
        )
    ...
    def _create_resource_provider(
        ...
        seed_dataset_config = None
        if (seed_config := config_builder.get_seed_config()) is not None:
            seed_dataset_config = seed_config.config
        ...
        return create_resource_provider(
            ...
            seed_dataset_config=seed_dataset_config,
            seed_dataset_reader_registry=self._seed_dataset_reader_registry,
        )
