...
MANAGED_ASSETS_PATH = Path(os.getenv(MANAGED_ASSETS_PATH_ENV_VAR, DATA_DESIGNER_HOME_DIR / "managed-assets"))
...
PERSONAS_DATA_CATALOG_NAME = "nemotron-personas-datasets"
