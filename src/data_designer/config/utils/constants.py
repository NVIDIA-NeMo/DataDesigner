...
MANAGED_ASSETS_DIR_ENV_VAR = "DATA_DESIGNER_MANAGED_ASSETS_DIR"

MANAGED_ASSETS_DIR = Path(os.getenv(MANAGED_ASSETS_DIR_ENV_VAR, DATA_DESIGNER_HOME_DIR / "managed-assets"))
...
PERSONAS_DATA_CATALOG_NAME = "nemotron-personas-dataset"
