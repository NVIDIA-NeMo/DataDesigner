...
class SeedDatasetColumnGenerator(FromScratchColumnGenerator[SeedDatasetMultiColumnConfig]):
    ...
    def metadata() -> GeneratorMetadata:
        return GeneratorMetadata(
            ...
            required_resources=[ResourceType.SEED_DATASET_READER],
        )
    ...
    def duckdb_conn(self) -> duckdb.DuckDBPyConnection:
        return self.resource_provider.seed_dataset_reader.create_duckdb_connection()
    ...
    def _initialize(self) -> None:
        ...
        self._dataset_uri = self.resource_provider.seed_dataset_reader.get_dataset_uri()
