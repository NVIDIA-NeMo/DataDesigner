...
<Note title="Prerequisites">
  Most recipes use the OpenAI model provider by default. Image-generation recipes use OpenRouter and Gemini image models by default, so set `OPENROUTER_API_KEY` before running them unless you override the model provider and model ID.
</Note>
