...
<CardGroup cols={2}>
  <Card title="Chart Question Answering" icon="chart-line" href="/recipes/chart-qa/chart-question-answering">
    Generate balanced or failure-focused chart QA with grounded reasoning traces and quality checks.
  </Card>
</CardGroup>
