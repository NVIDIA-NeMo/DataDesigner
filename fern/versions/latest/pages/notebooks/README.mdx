...
| [Generating Word Documents (Colab)](https://colab.research.google.com/github/NVIDIA-NeMo/DataDesigner/blob/main/docs/colab_notebooks/8-generating-word-documents.ipynb) | Use a processor plugin to turn generated rows into `.docx` files |
