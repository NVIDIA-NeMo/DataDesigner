...
Instead of walking through one giant example line by line, let's look at a few use cases. Image generation gets more interesting when you see it jump domains: documents, apparel, ego-camera traffic scenes, robot viewpoints, baggage scans, X-rays, crops, drone frames, and one deliberately unserious pet-editing example at the end. The code shape stays familiar, but the distributions change completely. Each use case also has an accompanying recipe linked at the bottom if you want to explore it on your own.
...
<ImageExample
  ...
  controls={[
    ...
    ["time of day", "mid-morning - bright sun, long shadows"],
...
<ImageExample
  title={"Example 3: intersection - 4-way with traffic lights · traffic light malfunctioning - flashing red"}
  ...
  controls={[
    ...
    ["weather", "light rain - misty windshield"],
    ["time of day", "mid-morning - bright sun, long shadows"],
    ["traffic density", "empty - no other vehicles visible"],
    ["vehicle mix", "includes large trucks/semi-trailers"],
    ["scenario element", "traffic light malfunctioning - flashing red"],
    ["road surface", "recent patching - uneven surface"],
    ["traffic control", "speed limit sign - 25 mph"],
  ]}
/>
...
<ImageExample
  title={"Example 2: left tibia and fibula · boxer's fracture of the fifth metacarpal neck"}
...
<ImageExample
  title={"Example 4: left ankle · radial head fracture"}
  src={"/assets/image-generation-for-multimodal-data-pipelines/examples/medical-extremity-xrays/04.jpg"}
  alt={"Synthetic research-only extremity X-ray style image"}
  imageWidth={"50%"}
  controls={[
    ["anatomical region", "left ankle"],
    ["xray view", "weight-bearing AP"],
    ["primary finding", "radial head fracture"],
    ["secondary findings", "old healed fracture with callus formation"],
...
<ImageExample
  title={"Example 3: commercial flat roof · small crack or seam separation"}
  ...
  controls={[
    ...
    ["altitude", "higher overview pass, about 100 meters above the target"],
    ["camera angle", "shallow side-looking pass"],
    ["defect or event", "small crack or seam separation"],
    ["severity", "severe and clearly visible"],
    ["occlusion", "motion blur from drone movement"],
  ]}
/>
