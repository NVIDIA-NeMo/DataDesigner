...
Unlike raw LLM calls, Data Designer gives you statistical diversity, field correlations, automated validation, and reproducible workflows. For details, see [Architecture & Performance](/concepts/architecture-performance).
...
- **[Architecture & Performance](/concepts/architecture-performance)** – Optimize for throughput and scale
