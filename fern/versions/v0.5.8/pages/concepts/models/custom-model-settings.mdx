...
- **[Default Model Settings](/concepts/models/default-model-settings)**: Pre-configured providers and model settings
- **[Configure Model Settings With the CLI](/concepts/models/configure-with-the-cli)**: CLI-based configuration
