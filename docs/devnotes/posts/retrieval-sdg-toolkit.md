...
If your users ask questions that span multiple documents - for example, "How does the migration guide change the deployment recommendation from the architecture overview?" - enable multi-document bundling:
...
## **Step 3: Remove Duplicates Before They Become Training Data**
...
## **Step 4: Judge Quality Before Export**
...
## **Step 5: Export What Training and Eval Actually Need**
...
- Compatibility metadata and installation through the Data Designer plugin catalog.
...
- [NeMo reranking fine-tune recipe](https://github.com/NVIDIA-NeMo/Nemotron/tree/preview/rerank-finetune-recipe-v1/src/nemotron/recipes/rerank)
