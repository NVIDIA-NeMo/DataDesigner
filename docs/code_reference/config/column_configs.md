...
!!! note "Config"
    This page documents user-facing config objects in `data_designer.config.column_configs`. If you are implementing a column generator plugin or changing engine behavior, see [column_generators](../engine/column_generators.md).
